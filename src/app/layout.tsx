...
export const metadata: Metadata = {
  title: 'أفضل شركة حقن تربة في المنطقة الشرقية | شركة هامات يوناتيد – فحص وضمان 10 سنوات',
  description:
     'شركة هامات يوناتيد – خبرة في حقن التربة بالمنطقة الشرقية مع ضمان 10 سنوات وفحص شامل قبل وبعد التنفيذ. خدمات معتمدة في اختبارات التربة، الصخور، الخرسانة، الأسفلت، وضبط الجودة. اتصل بنا الآن على +966 13 565 0006.',
  keywords:
    'حقن التربة, شركة هامات يوناتيد, مختبر فحص تربة المنطقة الشرقية, اختبارات التربة, اختبارات الصخور, اختبارات الخرسانة, ضبط الجودة, ضمان عشر سنوات, الدراسات الجيوتقنية, فحص التربة قبل البناء',
