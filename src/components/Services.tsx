...
const SERVICES = [
  ...
  {
    title: 'اختبار جهاز الـ GPR',
    description:
      'نقدم خدمة المسح الرداري الارضي (GPR) باستخدام احدث الاجهزة المتطورة للكشف عن التجاويف والفجوات والبنية التحتية المدفونة تحت الارض دون الحاجة للحفر.',
  },
];
