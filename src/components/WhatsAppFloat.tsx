...
const WhatsAppFloat = () => {
  ...
  const handleWhatsAppClick = () => {
    ...
    const rawPhone = whatsappConfig.phone ?? '';
    ...
    <>
      ...
      >
        <div className="relative">
          ...
          <div
            className={`absolute inset-0 rounded-full ${ringClass} transition-all duration-1000 ${
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <svg 
                className="w-10 h-10 text-current group-hover:scale-110 transition-transform duration-300" 
                fill="currentColor" 
                viewBox="0 0 24 24"
              >
